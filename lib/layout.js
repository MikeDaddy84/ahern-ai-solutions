...
function renderPage({ title, description, bodyHtml, canonicalPath, ogType, jsonLd }) {
...
<head>
  ...
  <link rel="stylesheet" href="/styles.css?v=hero-demo-2" />
...
${bodyHtml}
  ...
  <script src="/script.js?v=hero-demo-2"></script>
</body>
</html>`;
}

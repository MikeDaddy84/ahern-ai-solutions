...
function document(title, body, page = 'login') {
  return `<!doctype html><html lang="en" data-theme="light"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>${h(title)} — Ahern AI</title><link rel="icon" href="/brand/favicon.png"><link rel="stylesheet" href="/styles.css?v=studio-1"><link rel="stylesheet" href="/portal.css?v=1"></head><body class="portal" data-page="${h(page)}"><a class="skip-link" href="#main">Skip to content</a>${body}<script src="/portal.js?v=1" defer></script></body></html>`;
}
...
function satoriPage(user, preview) {
  ...
  return shell({...user,preview,view:'satori',content}).replace('</head>',`${assets}<link rel="stylesheet" href="/satori-portal.css?v=1"></head>`);
}

...
function createRouter({ storeProvider = require('./portal-auth').getStore, satori = require('./satori') } = {}) {
  ...
  require('./crew-room').install(router);

  ...
  return `
    ...
    <section class="container post">
      <div class="post-body">
        ...
        <p>Ahern AI Solutions is new. I would rather say that plainly than dress up a launch as a track record &mdash; you can read the difference anyway, and starting a relationship by overstating one is a poor trade for both of us.</p>
  ...
  return `
    ...
    <section class="container post">
      <div class="post-body">
        ...
        <h2>Your choices</h2>
        <p>Ask and I will tell you what has been stored about you, correct it, or delete it. There is no form for this and no waiting period. Email or call:</p>
        <p><a href="tel:${CONTACT_TEL}">${CONTACT_PHONE}</a></p>

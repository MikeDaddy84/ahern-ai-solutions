...
const services = {
  ...
  websites: {
    ...
    cta: 'Discuss my website or tool', interest: 'Website or custom app', secondaryHref: '#intake-demo', secondaryLabel: 'Follow an inquiry',
    outcomes: [
    ...
    questions: [
      ['Can I get a website without automation?', 'Yes. Standalone website engagements start at $9,500 with their own agreed scope. The Front Door is a focused website-and-intake package at $6,500–9,500. Page count, content, and integrations are confirmed in your quote.'],
      ['What happens after launch?', 'The first 12 months of the agreed care plan are included in the project price. After that, care is month to month at $249–399. Maintenance allowances and responsibilities are agreed before launch; new features and growth projects are separate.'],

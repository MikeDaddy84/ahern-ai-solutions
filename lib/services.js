...
const services = {
  automation: {
    ...
    questions: [
      ...
      ['Do I need custom software?', 'Usually not. The automation packages connect existing tools and platforms. A purpose-built dashboard, client portal, or internal app is scoped separately when a simpler workflow will not do the job.']
    ]
  },
  'custom-pcs': {
  ...
  websites: {
    ...
    questions: [
      ...
      ['Do I need a custom app?', 'Not necessarily. We look at the process first and check whether existing software or an automation package can cover it before scoping a custom tool.']
    ]
  }
};

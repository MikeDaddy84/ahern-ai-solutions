...
function sitemapXml() {
  const staticPages = [
    ...
    { path: '/services/custom-pcs', priority: '0.9', changefreq: 'monthly' },
    { path: '/services/local-ai', priority: '0.9', changefreq: 'monthly' },
    { path: '/services/websites', priority: '0.8', changefreq: 'monthly' },
    { path: '/services/networks-cabling', priority: '0.8', changefreq: 'monthly' },

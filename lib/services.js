...
const services = {
  'networks-cabling': {
    title: 'Networks and cabling for North Texas businesses', eyebrow: 'Networks & cabling',
    heading: 'Reliable connections.\nA setup that works.',
    intro: 'Switch installation, Ethernet testing and troubleshooting, and copper and fiber termination for your business. I inspect the existing setup first, then provide a written quote for the work you need.',
    cta: 'Request a network assessment', interest: 'Networks & cabling',
    outcomes: [
      ['Connect your equipment', 'Install and configure network switches around your devices, available ports, and the way your business works.'],
      ['Find the connection problem', 'Test and troubleshoot Ethernet connections, trace and label cables, and repair or terminate copper cabling.'],
      ['Finish the physical connection', 'Terminate fiber, tidy connections, and document the agreed work so you know what connects where.']
    ],
    fit: 'Tell me where the work is, what is connected, and what is failing or needs to change. We arrange a site visit so I can inspect the equipment, cabling, and access before recommending the work.',
    scope: 'Every project is quoted after an on-site assessment. Your written quote sets out equipment, materials, labor, testing, and any planned downtime. Any assessment or travel charge is agreed before the visit. You approve the quote before installation or repairs begin.',
    link: '/resources#networks-cabling', linkLabel: 'Prepare for the site visit',
    questions: [
      ['Can you give me a price before seeing the setup?', 'I need to see the existing equipment, cable routes, terminations, and access first. Once I have assessed the site, I provide a written quote for the agreed work. There is no fixed package price or online estimate.'],
      ['Can you install a switch or test my existing Ethernet?', 'Yes. I can install and configure switches, test and troubleshoot existing Ethernet connections, and repair or terminate copper cabling. The site assessment determines what needs doing.'],
      ['Do you terminate fiber?', 'Yes. Fiber termination can be included after I inspect the existing fiber, connector requirements, and access. Materials and the agreed testing are included in the quote.'],
      ['Will the work interrupt our connection?', 'Some work may require downtime. I identify the affected connections and agree a suitable work window with you before starting.'],
      ['What happens after the work?', 'I complete the checks agreed in your quote and hand over the relevant setup notes, cable labels, and test results. Any follow-up support is scoped separately.']
    ]
  },
  automation: {
    title: 'AI automation for North Texas businesses', eyebrow: 'AI automation for businesses',
    heading: 'Turn busywork into\nclear next steps.',
  ...
  'local-ai': {
    ...
    secondaryHref: '#ai-fit', secondaryLabel: 'Check my AI fit',
    outcomes: [
  ...
  websites: {
    ...
    intro: 'Get a website you are proud to send people to, from $995. Start with the pages and contact form your business needs, then add automation when you are ready to simplify the work behind it.',
    cta: 'Plan my website', interest: 'Website or custom app', secondaryHref: '#web', secondaryLabel: 'Compare website packages',
    outcomes: [
      ['Get your business online', 'Show customers what you do with a polished site that works on phones and desktops.'],
      ['Give customers a next step', 'Make it easy to get in touch. Add inquiry routing and follow-up automation when you need it.'],
    ...
    scope: 'Website Starter is $995 for one page. Business Website is $1,995 for up to five pages. The Front Door starts at $2,995 with one defined automation. Each website package includes two revision rounds; optional care is $99/month from launch.',
    link: '#web', linkLabel: 'See website and tool pricing',
    questions: [
      ['Can I get a website without automation?', 'Absolutely. Website Starter is $995 for one page, and Business Website is $1,995 for up to five pages. Both include a mobile-friendly layout, a contact form, basic search setup, domain connection, and two revision rounds. Automation is optional and can be added later.'],
      ['What happens after launch?', 'Optional website care is $99/month from launch for hosting, routine maintenance, and up to 20 minutes of minor edits monthly, with no rollover. Care is separate from the build price and is month to month. New features and automation support are quoted separately. If you prefer your own hosting, we agree the handoff before launch. Existing agreements retain their terms.'],
      ['What should I provide, and what costs extra?', 'Bring your business details, logo, and images. The Business Website and Front Door packages include help shaping supplied content. Domain registration, paid assets, third-party subscriptions, substantial content work, migrations, stores, portals, and complex integrations are separate. We confirm your scope before work begins.'],
...
function serviceHtml(slug) {
  ...
  const tools = {
    automation: [['#value-calculator','Estimate the value of your workflow']],
    'custom-pcs': [['/pc-builder?track=everyday','Plan an everyday or office PC']],
    'local-ai': [['#document-demo','Explore a sample document answer']],
    websites: [['#website-fit','Check your inquiry process']],
    'networks-cabling': []
  }[slug];
  const toolLinks = tools.concat([['/resources#'+slug,'Free project checklist']]).map(([url,label])=>`<a class="text-link" href="${url}">${label} →</a>`).join('');
  return `<section class="container service-hero"><a class="service-back" href="/#services">← All services</a><p class="eyebrow">${escapeHtml(s.eyebrow)}</p><h1>${escapeHtml(s.heading).replace('\n', '<br>')}</h1><p class="section-sub">${escapeHtml(s.intro)}</p><div class="service-actions"><a class="btn btn-primary" href="${href}">${escapeHtml(s.cta)} →</a>${secondaryHref ? `<a class="btn btn-ghost" href="${secondaryHref}">${escapeHtml(secondaryLabel)}</a>` : ''}</div><nav class="service-tool-links" aria-label="Planning tools">${toolLinks}</nav></section>

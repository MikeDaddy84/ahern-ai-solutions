  ...
  return `
    ...
    <section class="container post">
      <div class="post-body">
        ...
        <h2>Cookies</h2>
        <p><strong>No advertising or analytics cookies are set.</strong> While the site is behind its pre-launch password, an access cookie remembers that you have signed in.</p>
